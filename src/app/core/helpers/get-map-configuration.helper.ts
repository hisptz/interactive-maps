import { MapConfiguration, Visualization } from '../models';
...
export function getMapConfiguration(visualizationObject: Visualization): MapConfiguration {
  return {
    ...
    basemap:
      visualizationObject.details.basemap && visualizationObject.details.basemap
        ? visualizationObject.details.basemap
        : 'osmlight',
